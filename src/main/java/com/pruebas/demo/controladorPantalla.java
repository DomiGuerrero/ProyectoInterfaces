...
public class controladorPantalla {
    ...
    public void btnEscenaGeneros(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("EscenaGeneros.fxml"));
    ...
    public void btnEscenaDirectores(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("EscenaDirectores.fxml"));
        Main.mainNode.setCenter( fxmlLoader.load());
    }

    public void btnEscenaPeliculas(ActionEvent actionEvent) throws IOException {
    ...
    public void seleccionPelicula(KeyEvent keyEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("Pelicula.fxml"));
        Main.mainNode.setCenter(fxmlLoader.load());
    }
}
